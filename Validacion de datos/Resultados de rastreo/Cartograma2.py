...
RX_pos=[-0.227055,-78.457184]
TX_pos=[-0.226720,-78.456268]
...
center_pt = [-0.227101,-78.456497] # lat/lon of One World Trade Center in NYC
...
Dist_vincenty=distance_between([-78.456474,-0.227133],end_point)
Azimuth_forward=course_to([-78.456474,-0.227133],end_point)
...
ax1.plot([-78.456474,TX_pos[1]],[-0.227133,TX_pos[0]],'--',label=str_dist2,markeredgewidth=7.0,color='magenta',lw=2.5, transform=ccrs.PlateCarree())
...
ax1.plot(-78.456474,-0.227133,label='RX/POS2',markersize=20,markeredgewidth=1.0, marker='*', linestyle='', color='orange', transform=ccrs.PlateCarree())#Destino
