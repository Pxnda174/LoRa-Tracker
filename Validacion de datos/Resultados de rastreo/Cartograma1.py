...
RX_pos=[-0.232190,-78.456070]
TX_pos=[-0.232637,-78.455139]

raw_data = 'Tracker1.csv'
...
center_pt = [-0.232190,-78.456062] # lat/lon of One World Trade Center in NYC
zoom = 0.00055 # for zooming out of center point
extent = [center_pt[1]-(zoom*1.1),center_pt[1]+(zoom*2.0),center_pt[0]-zoom,center_pt[0]+zoom] # adjust to zoom
print(extent)
...
Dist_vincenty=distance_between([-78.455566,-0.232273],end_point)
Azimuth_forward=course_to([-78.455566,-0.232273],end_point)
...
ax1.plot([-78.455566,TX_pos[1]],[-0.232273,TX_pos[0]],'--',label=str_dist2,markeredgewidth=7.0,color='magenta',lw=2.5, transform=ccrs.PlateCarree())
...
ax1.plot(RX_pos[1],RX_pos[0],label='RX/POS1',markersize=20,markeredgewidth=1.0, marker='^', linestyle='', color='green', transform=ccrs.PlateCarree())#Destino
ax1.plot(-78.455566,-0.232273,label='RX/POS2', markersize=20, markeredgewidth=1.0, marker='*', linestyle='', color='orange', transform=ccrs.PlateCarree())#Destino
