...
Fig1.suptitle('Distancia=195m, SF12=-20dB, Bandwidth=250kHz, Coding rate=4/7, Automatic gain control=ON',fontsize=15,fontweight='bold')
...
ax2.set_xlabel('Item',fontsize=14,style='italic')
ax2.set_ylabel('degrees(°)',fontsize=14,style='italic')
Fig2.suptitle('Distancia=195m, SF12=-20dB, Bandwidth=250kHz, Coding rate=4/7, Automatic gain control=ON',fontsize=15,fontweight='bold')
...
ax2.plot(muestreo,snr_RX,linewidth=3)
ax2.grid(visible=True, which='major', color='#300000', linestyle='-')
ax2.minorticks_on()
ax2.grid(visible=True, which='minor', color='#900000', linestyle=':')
ax2.set_title('Variación SNR',fontsize=14,style='italic')
ax2.set_xlabel('Item',fontsize=14,style='italic')
ax2.set_ylabel('dB',fontsize=14,style='italic')
ax2.plot([-0, 480], [-20.0, -20.0], color="green", linewidth=3)

ax3.plot(muestreo,rssi_RX,linewidth=3)
ax3.grid(visible=True, which='major', color='#300000', linestyle='-')
ax3.minorticks_on()
ax3.grid(visible=True, which='minor', color='#900000', linestyle=':')
ax3.set_title('Variación RSSI',fontsize=14,style='italic')
ax3.set_xlabel('Item',fontsize=14,style='italic')
ax3.set_ylabel('dB',fontsize=14,style='italic')
Fig3.suptitle('Distancia=195m, SF12=-20dB, Bandwidth=250kHz, Coding rate=4/7, Automatic gain control=ON',fontsize=15,fontweight='bold')
