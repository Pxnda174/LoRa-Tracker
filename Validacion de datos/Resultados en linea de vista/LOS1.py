...
osm_img = cimgt.OSM()#cimgt.QuadtreeTiles() # spoofed, downloaded street map
...
center_pt = [-0.223988, -78.463194 ]
#center_pt = [-0.232650, -78.462893]
...
str_dist='Distancia1='+str(int(Dist_cartopy))+' m'


ax1.plot(GPS_pos1_Long, GPS_pos1_Lati,'--',label=str_dist,markeredgewidth=7.0,color='darkorange',lw=2.5, transform=ccrs.PlateCarree())
ax1.plot([-78.471235,TX_pos[1]],[-0.217360,TX_pos[0]],'--',label='Distancia2=2700 m',markeredgewidth=7.0,color='black',lw=2.5, transform=ccrs.PlateCarree())

ax1.plot(TX_pos[1],TX_pos[0],label='Transmisor', markersize=20,markeredgewidth=5.0, marker='x', linestyle='', color='blue', transform=ccrs.PlateCarree())#Origen
ax1.plot(RX_pos[1],RX_pos[0],label='Receptor1',markersize=20,markeredgewidth=0.1, marker='^', linestyle='', color='deeppink', transform=ccrs.PlateCarree())#Destino

ax1.plot(-78.471235,-0.217360,label='Receptor2',markersize=20,markeredgewidth=0.1, marker='p', linestyle='', color='deeppink', transform=ccrs.PlateCarree())#Destino
...
ax3.set_xlabel('Item')
ax3.set_ylabel('dB')
ax3.plot([-0, 180], [-20.0, -20.0], color="green", linewidth=3)
...
ax4.set_xlabel('Item')
ax4.set_ylabel('dB')
ax4.plot([-0, 180], [-135, -135], color="green", linewidth=3)
